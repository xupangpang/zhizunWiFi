...
import com.zhizun.zhizunwifi.view.WiFiLoadingCircleDrawable;
import com.zhizun.zhizunwifi.view.WiFiLoadingDrawable;
...
public class CircleView extends View {
    private WiFiLoadingCircleDrawable mDrawable;
    ...
    private void init(AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        if (attrs == null) {
            mDrawable = new WiFiLoadingCircleDrawable(resource.getDimensionPixelOffset(R.dimen.g_loading_minSize));
    ...
    public void isFinsh(boolean finsh) {
        mDrawable.setFinsh(finsh);
    }
    ...
    public void setLineStyle(int style) {
        mDrawable = new WiFiLoadingCircleDrawable(getResources().getDimensionPixelOffset(R.dimen.g_loading_minSize));
        mDrawable.setCallback(this);
    }
