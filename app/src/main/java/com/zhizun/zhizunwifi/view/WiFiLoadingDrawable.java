...
public abstract class WiFiLoadingDrawable extends Drawable implements android.graphics.drawable.Animatable, net.qiujuer.genius.ui.drawable.Animatable {
    ...
    public WiFiLoadingDrawable() {
        ...
        mBackgroundPaint.setPathEffect(pathEffect);
    ...
    public WiFiLoadingDrawable(int minSize) {
        this();
        MIN_SIZE = minSize;
    }
