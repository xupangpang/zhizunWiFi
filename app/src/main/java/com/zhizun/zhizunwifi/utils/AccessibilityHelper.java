 ...
 * @author LeonLee
 */
@SuppressLint("NewApi") public final class AccessibilityHelper {

    private AccessibilityHelper() {}

    /** 通过id查找*/
    @SuppressLint("NewApi") public static AccessibilityNodeInfo findNodeInfosById(AccessibilityNodeInfo nodeInfo, String resId) {
    ...
    /** 返回主界面事件*/
    @TargetApi(Build.VERSION_CODES.JELLY_BEAN) public static void performHome(AccessibilityService service) {
        if(service == null) {
            return;
        }
    ...
    /** 返回事件*/
    @SuppressLint("NewApi") public static void performBack(AccessibilityService service) {
        if(service == null) {
            return;
        }
