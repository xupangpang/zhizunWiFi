...
public class Config {
    ...
    public static final String ACTION_QIANGHONGBAO_SERVICE_DISCONNECT = "com.zhizun.zhizunwifi.ACCESSBILITY_DISCONNECT";
    public static final String ACTION_QIANGHONGBAO_SERVICE_CONNECT = "com.zhizun.zhizunwifi.ACCESSBILITY_CONNECT";

    public static final String ACTION_NOTIFY_LISTENER_SERVICE_DISCONNECT = "com.zhizun.zhizunwifi.NOTIFY_LISTENER_DISCONNECT";
    public static final String ACTION_NOTIFY_LISTENER_SERVICE_CONNECT = "com.zhizun.zhizunwifi.NOTIFY_LISTENER_CONNECT";
