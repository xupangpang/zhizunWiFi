...
public class NewsFragment extends BaseFragment {
	...
	private TextView new_title_ssid;
	private TextView new_title_ceshu;
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		status_bar_fix = (View)view.findViewById(R.id.status_bar_fix);
		status_bar_fix.setLayoutParams(new LinearLayout.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, TranslucentStatusBarUtils.getStateBarHeight(getActivity())));//填充状态栏

		new_title_ssid = (TextView)view.findViewById(R.id.new_title_ssid);


		new_title_ceshu = (TextView)view.findViewById(R.id.new_title_ceshu);
		new_title_ceshu.setOnClickListener(this);
	...
	public void onResume() {
		super.onResume();
		new_title_ssid.setText(wifiUtils.getConnectedSSID(wifiUtils.getConnectionInfo()));
	}
	...
	public void onClick(View v) {
		switch (v.getId()) {
			...
			case R.id.btnBack:
				...
				break;
			case R.id.new_title_ceshu:
				Intent intent8 = new Intent(getActivity(), PhysicalExaminationSpeedActivity.class);
