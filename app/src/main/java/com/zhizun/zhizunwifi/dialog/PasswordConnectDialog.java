...
public class PasswordConnectDialog {
	...
	public PasswordConnectDialog builder() {
		...
		bt_capdl_try = (CheckBox) contentView.findViewById(R.id.bt_capdl_try);

		alertText = (TextView) contentView.findViewById(R.id.alertText);


		bt_capdl_try.setOnCheckedChangeListener(new OnCheckedChangeListener() {
			@Override
