 ...
 *
 */
public class RefreshableView_old extends LinearLayout implements OnTouchListener {
...
//	private TextView updateAt;
	 ...
	 * @param attrs
	 */
	public RefreshableView_old(Context context, AttributeSet attrs) {
		super(context, attrs);
...
//		updateAt = (TextView) header.findViewById(R.id.updated_at);
	...
	public boolean onTouch(View v, MotionEvent event) {
		...
		if (ableToPull) {
			Log.i("RefreshableView", "currentStatus= " + currentStatus);
			switch (event.getAction()) {
				...
				case MotionEvent.ACTION_MOVE:
					...
					if (currentStatus != STATUS_REFRESHING) {
						...
						int nowHeaderHeight = (distance / 2) + hideHeaderHeight;
				...
				default:
					Log.e("RefreshableView", "手指抬起 currentStatus= " + currentStatus);
	...
	private void setIsAbleToPull(MotionEvent event) {
		...
		if (firstChild != null) {
			...
			if (firstVisiblePos == 0 && firstChild.getTop() == 0) {
				...
				if (listViewLayoutParams.topMargin != hideHeaderHeight) {
					listViewLayoutParams.topMargin = hideHeaderHeight;
					listView.setLayoutParams(listViewLayoutParams);
				}
				ableToPull = false;
