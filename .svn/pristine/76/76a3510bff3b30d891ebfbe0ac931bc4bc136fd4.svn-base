...
public class RouterLoadingIndicatorView extends View {

    private static final String TAG="AVLoadingIndicatorView";

    private static final RouterBallPulseIndicator DEFAULT_INDICATOR=new RouterBallPulseIndicator();
    ...
    private RouterBallPulseIndicator mIndicator;
    private int mIndicatorColor;

    private boolean mShouldStartAnimationDrawable;

    public RouterLoadingIndicatorView(Context context) {
        super(context);
        init(context, null,0,0);
    }

    public RouterLoadingIndicatorView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs,0, R.style.AVLoadingIndicatorView);
    }

    public RouterLoadingIndicatorView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context, attrs,defStyleAttr, R.style.AVLoadingIndicatorView);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public RouterLoadingIndicatorView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    public RouterBallPulseIndicator getIndicator() {
        return mIndicator;
    }

    public void setIndicator(RouterBallPulseIndicator d) {
        if (mIndicator != d) {
            if (mIndicator != null) {
    ...
    public void setIndicator(String indicatorName){
        ...
        try {
            ...
            RouterBallPulseIndicator indicator = (RouterBallPulseIndicator) drawableClass.newInstance();
